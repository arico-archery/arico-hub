...
async function main() {
  ...
  const suppliers = [
    ...
    // SIBUYA: discount는 calcCostJpy에서 브랜드별 처리 (SIBUYA=62%, 타브랜드=65%)
    { code: 'SIBUYA', name: 'Shibuya', currency: 'JPY', priceType: 'RETAIL', taxRate: 0.1, discount: 0, color: '#0ea5e9' },
  ...
  const sampleProducts = [
    ...
    { supplierCode: 'SIBUYA', productCode: 'SHB-ULTIMA-RC1', name: 'Shibuya Ultima RC DX Sight', brand: 'SHIBUYA', category: 'sights', costPrice: 68000, msrp: 68000, unit: '1' },
